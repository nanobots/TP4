...
//        size=0;
//        realoc() nuevo tamaño 10 lugares
    return returnAux;
}
...
int al_push(ArrayList* this, int index, void* pElement)
{
    ...
    if(this != NULL && pElement != NULL && index>=0 && index<al_len(this)){
        /*
        if index=leng(this) hago un add de pelement dentro de un if y retornamos 0
        espand(agranda el elemento) y al_set
